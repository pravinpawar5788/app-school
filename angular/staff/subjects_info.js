app.controller("mozzCtrl", function($scope,$http,$timeout,$log,$window,$sce,$interval,config,hotkeys,Pubnub){
	...
	$scope.entry={name:'',chapter:'',section:'',description:'',lesson_id:'',date:'',staff_id:''};
	...
	$scope.saveHomework=function (){	
		...
		$scope.disableButtons();
		var data='rid='+$scope.pid+'&section='+encodeURIComponent($scope.entry.section)+'&homework='+encodeURIComponent($scope.entry.description);
