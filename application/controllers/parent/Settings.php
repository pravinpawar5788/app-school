...
class Settings extends parent_Controller{
...
*/	
    ...
    */
    ...
    public function updatePassword(){ 
            ...
            $npassword=$this->parent_m->hash($form['npassword']);  
            //save data in database
            if($this->parent_m->save(array('password'=>$npassword),$this->LOGIN_USER->mid)===false){
                $this->RESPONSE['error']=TRUE;
