...
<div class="content">
	...
	<div class="card">
		<div class="card-header bg-transparent">
			...
			<span class="text-muted">All registered parents can login into parents portal &amp; and leave feedback about institute performance. Find below the feedback left by parents.</span>
		</div>
		...
		<table class="table tasks-responsive table-lg">
			<thead>
				<tr>
					...
					<th class="font-weight-bold">Parent ID</th>
					<th class="font-weight-bold">Parent Name</th>
			...
			<tbody>
				...
				<tr ng-repeat="row in responseData.rows">
	                ...
	                <td>
	                	<div><a class="font-weight-semibold">{{row.parent.name}}</a></div>
					</td> 
					<td><a ng-href="<?php print $this->CONT_ROOT.'fbview/'?>{{row.mid}}">{{row.title}}</a><span ng-show="row.org_status==='0'" class="badge badge-success ml-2">New</span></td>
					<td>
						<div class="list-icons float-right">
							<div class="btn-group list-icons-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a class="dropdown-item" ng-href="<?php print $this->CONT_ROOT.'fbview/'?>{{row.mid}}"><i class="icon-eye"></i> Open Message
									</a>
									...
									<a class="dropdown-item" ng-click="delRow(row)"><i class="icon-cross"></i> Delete Message</a>
									<?php } ?>
								</div>
							</li>
						</div>
...
<div id="students" class="modal fade" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-success">
				<h6 class="modal-title">Registered Children of (<strong>{{selectedRow.parent.name}}</strong>) </h6>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
