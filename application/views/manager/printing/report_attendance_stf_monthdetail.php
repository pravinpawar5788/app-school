...
<div class="content" >
	      ...
	      <div class="page" style="line-height: 1;">
			...
			<div class="row form-block">
				<div class="col-sm-12 form-block-head" style="height: 1.3em;">
					<span class="">Staff Attendance Register
					...
					<div class="row">				
					    <table class="table table-sm">
					        ...
					        <tbody>
								...
								?>
						            <tr>
						            	<td class=""><?php print ++$index;?></td>
						                <td class=""><?php print $row['name'];?></td>
										<?php 
									    	$working_day=0;
									    	$present=0;
									    	$absent=0;
									    	...
									    	if(!empty($attendance)){
									    		...
									    		for ($i=0; $i < $days_in_month; $i++) {
									    			$day='d'.($i+1);
									    			if($attendance->$day==$this->stf_attendance_m->LABEL_HOLIDAY){$working_day--;}
									    	...
									    	if(!empty($attendance)){
									    		for ($i=0; $i < $days_in_month; $i++) {
								    				...
								    				if(empty($attendance->$day)){
								    					...
								    					?><td class=""><?php print strtoupper($attendance->$day);?></td><?php
										    		}
									    		}
									    	}else{
									    		for ($i=0; $i < $days_in_month; $i++) {
	...
	<?php print $this->config->item('app_print_code');?>3005 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
