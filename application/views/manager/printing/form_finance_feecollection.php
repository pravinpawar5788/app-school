...
$params['orderby']='class_id ASC, section_id ASC, roll_no ASC, mid ASC';
...
<div class="content" >
	...
	<p class="text-center">
		Fee Collection Form
		<?php isset($form['class']) && !empty($form['class']) ? print ' for class '.$classes[$form['class']] : '';
		 	print ' - '.$this->student_m->date;
		?>
	</p>
	<table>
	<thead>
			    ...
			    <table class="table table-sm">
			        <thead>
			            <tr>
			                ...
			                <th class="font-weight-semibold text-center" width="15%">Computer No</th>
			                ...
			                <th class="font-weight-semibold text-center" width="15%">Received</th>
			                <th class="font-weight-semibold text-center" width="10%">Date</th>
			            </tr>
			        </thead>
			        <tbody>
						...
						$i=0;
						$total_amount=0;
						$fee_filter=array('campus_id'=>$this->CAMPUSID,'status <>'=>$this->std_fee_voucher_m->STATUS_PAID);
						foreach($students as $usr){
							$amount=0;
							$fee_filter['student_id']=$usr['mid'];
							$vouchers=$this->std_fee_voucher_m->get_rows($fee_filter);
						...
						?>
				            <tr>
				                ...
				                <td class="text-center"><?php print $usr['computer_number'];?></td>
				                <td class="text-center"><?php print $usr['roll_no'];?></td>
				                <td class="text-center"><?php print $this->SETTINGS[$this->system_setting_m->_CURRENCY_SYMBOL].$amount;?></td>
				                <td></td>
				                <td></td>
	...
	<?php print $this->config->item('app_print_code');?>5005 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
