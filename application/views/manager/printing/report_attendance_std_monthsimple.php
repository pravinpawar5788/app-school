...
<div class="content" >
	      ...
	      <div class="page" style="line-height: 1;">
			...
			<div class="row form-block">
				<div class="col-sm-12 form-block-head" style="height: 1.3em;">
					<span class=""> Student Monthly Attendance Summary 
						    ...
						    <table class="table table-sm">
						        <thead>
						            <tr>
						                ...
						                <th class="font-weight-semibold text-center" width="20%">Class</th>
						                <th class="font-weight-semibold text-center" width="20%">Student</th>
	...
	<?php print $this->config->item('app_print_code');?>3006 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
