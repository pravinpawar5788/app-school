...
$class=$this->class_m->get_by_primary($student->class_id);
								...
								<p class="para">
									...
									<?php if(isset($form['p_pos'])){
										...
										foreach($stds as $std){
								            ...
								            $std_result=0;if($total_marks>0 && $obt_marks>0){$std_result=($obt_marks/$total_marks)*100;}
							...
							<table class="table table-sm text-center table-solid">
						        ...
						        <?php if($total_obt_marks>0 && $total_subject_marks>0){
						        	if(!isset($form['p_rgrd'])){
						        		...
						        		if(round(($total_obt_marks/$total_subject_marks)*100) < $this->CAMPUSSETTINGS[$this->campus_setting_m->_MONTH_OPASS_PERCENT]){
						        				$final_status="<span class=''>Fail</span>";
						        				$grades_final_status="<span class=''>Failed</span>";
						        		}else{
						        				$final_status="<span class=''>Pass</span>";
						        ...
						        <tfoot>
						            <tr>
					                	...
					                	<th class="font-weight-bold" style="border:1px solid black;background-color: #B8B8AA;">
					                		<?php print $this->std_result_m->get_grade($total_subject_marks,$total_obt_marks);?></th>
