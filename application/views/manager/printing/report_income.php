...
$params=array();
$rows=$this->income_m->get_rows($filter,$params);
...
<div class="content">
	...
	<?php print $this->config->item('app_print_code');?>5001 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
