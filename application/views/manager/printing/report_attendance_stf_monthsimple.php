...
$staffs=$this->staff_m->get_rows($filter,$params);
?>
<!-- Main content -->
...
<div class="content" >
	      ...
	      <div class="page" style="line-height: 1;">
			...
			<div class="row form-block">
				<div class="col-sm-12 form-block-head" style="height: 1.3em;">
					<span class="">Staff Attendance Summary
						    ...
						    <table class="table table-sm">
						        <thead>
						            <tr>
						                ...
						                <th class="font-weight-semibold text-center">Staff</th>
						                <th class="font-weight-semibold text-center">Month Days</th>
						                <th class="font-weight-semibold text-center">Holidays</th>
						                <th class="font-weight-semibold text-center">Present</th>
						                <th class="font-weight-semibold text-center">Absent</th>
						                <th class="font-weight-semibold text-center">Leave</th>
						                <th class="font-weight-semibold text-center">Not Marked</th>
						            </tr>
						        </thead>
						        <tbody>
									...
									?>
							            <tr>
											...
											<?php 
										    	...
										    	$holiday=0;
										    	$not_marked=0;
										    	$attendance=$this->stf_attendance_m->get_by(array('campus_id'=>$this->CAMPUSID,'session_id'=>$activeSession->mid,'staff_id'=>$row['mid'],'month'=>$month,'year'=>$year),true);
										    	if(!empty($attendance)){
										    		...
										    		for ($i=0; $i < $days_in_month; $i++) {
										    			...
										    			switch ($attendance->$day) {
										    				case $this->stf_attendance_m->LABEL_PRESENT: {$present++;}break;
										    				case $this->stf_attendance_m->LABEL_LEAVE: {$leave++;}break;
										    				case $this->stf_attendance_m->LABEL_HOLIDAY: {$holiday++;}break;			    				
										    				case $this->stf_attendance_m->LABEL_ABSENT: {$absent++;}break;			    				
										    				default: { $not_marked++;}break;
										    			}
										    		}
										    	}
										    ?>
										    <td class="text-center"> <?php print $days_in_month;?> </td>
										    <td class="text-center"><?php print $holiday>0? $holiday : '-';?></td>
										    <td class="text-center"><?php print $present>0? $present : '-';?></td>
										    <td class="text-center"><?php print $absent>0? $absent : '-';?></td>
										    <td class="text-center"><?php print $leave>0? $leave : '-';?></td>
										    <td class="text-center"><?php print $not_marked>0? $not_marked : '-';?></td>
							            </tr>
							        <?php } ?>
						        </tbody>
						    </table>
	...
	<?php print $this->config->item('app_print_code');?>3004 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
