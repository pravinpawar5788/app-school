...
$students=$this->student_m->get_rows($std_filter,array('orderby'=>'section_id ASC, class_id ASC, roll_no ASC, mid ASC','select'=>'mid,class_id,section_id,name,roll_no,guardian_name,guardian_mobile,computer_number'));
...
<div class="content" >
			    ...
			    <table class="table table-sm">
			        <thead>
			            <tr>
			                ...
			                <th class="font-weight-semibold text-center" width="10%">Comp.</th>
			        ...
			        <tbody>
						...
						foreach($students as $row){
							...
							$filter['type']=$this->std_fee_entry_m->TYPE_FEE;
						...
						?>
				            <tr>
				                ...
				                <td class="text-center"><?php print $row['computer_number'];?></td>
	...
	<?php print $this->config->item('app_print_code');?>5004 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
