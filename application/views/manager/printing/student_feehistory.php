...
$params=array();
$rows=$this->std_fee_history_m->get_rows($filter,$params);
...
<div class="content">
	...
	<p class="text-center">Fee History of <strong><?php print ucwords(strtolower($member->name));?></strong></p>
	      ...
	      <div class="page" style="line-height: 1;">
			    ...
			    <table class="table table-sm">
			        <thead>
			            <tr>
			                ...
			                <th class="font-weight-semibold text-center" width="20%">Amount</th>
			                <th class="font-weight-semibold text-center" width="20%">Date</th>
			            </tr>
			        </thead>
			        <tbody>
			        	<?php
			        	...
			        	if(count($rows)<1){
			        		?>
			        		<tr>
				            	<td colspan="4"><span class="font-weight-semibold text-danger"><?php print ucwords(strtolower($member->name)); ?> has not yet paid any fee!</span></td>			                
				            </tr>
			        	<?php
			        	}else{
				        	foreach($rows as $row){
				            ...
				            <tr>
				                ...
				                <td class="text-center"><?php print $row['amount'];?></td>
			...
			<div class="row">
				<div class="col-sm-4 border-solid text-center">
					<span class="text-bold">Total Fee Paid(by student) :</span>
				</div>
				<div class="col-sm-4 grd-bg-orange border-white text-center">
					<span class="text-bold"> <?php print $this->SETTINGS[$this->system_setting_m->_CURRENCY_SYMBOL].$total_paid;?> </span>
				</div>
			</div>
	...
	<?php print $this->config->item('app_print_code');?>2004 <span class="page-footer-right"><?php print ucwords($this->SETTINGS[$this->system_setting_m->_ORG_NAME]);?></span>
	</div>	
