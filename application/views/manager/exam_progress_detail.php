		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Student Progress Detail</span>
				</div>
		...
		<div class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="navbar-collapse collapse" id="navbar-second">
				<ul class="nav navbar-nav">
					...
					<li class="nav-item">
						<a href="<?php print $this->LIB_CONT_ROOT.'exam/progress';?>" class="navbar-nav-link" style="color:<?php $clr=get_random_hax_color('dark'); print $clr;?>;">
			    ...
			    <div class="tab-pane fade <?php print empty($tab) || $tab=='profile' ? 'active show': '';?>" id="profile"><!-- List table -->
					<div class="card">
						<div class="card-header bg-transparent">
							<h4 class="card-title"><code><?php print $record->name; ?></code> Progress details in tests</h4>
							<span class="text-muted">Find below the students performance in the test. You may filter the results of other sessions.</span>
						</div>
						<div class="card-body">
							<div class="row">	
								<div class="col-sm-3">
