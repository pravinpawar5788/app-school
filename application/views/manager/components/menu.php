			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="<?php print $this->LIB_CONT_ROOT;?>settings/profile" class="dropdown-item"><i class="icon-vcard"></i>Profile Settings</a>
						<a href="<?php print $this->APP_ROOT;?>auth/logout" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
					</div>
				</li>
			</ul>
		</div>
