...
<head>
  ...
  <title><?php print ucwords($this->config->item('app_name'));?> | Campus Portal</title>
  ...
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>manager/app_module.js<?php print $this->FILE_VERSION;?>"></script>
  <?php  foreach($this->ANGULAR_INC as $inc){?>
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>manager/<?php print $inc;?>.js<?php print $this->FILE_VERSION;?><?php print mt_rand(111111,999999);?>"></script>
  <?php }} ?>
  <!-- /angular js files -->
