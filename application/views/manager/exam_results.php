			    ...
			    <div class="tab-pane fade <?php print empty($tab) || $tab=='profile' ? 'active show': '';?>" id="profile"><!-- List table -->
					<div class="card">
						<div class="card-header bg-transparent">
							<h4 class="card-title">Students Final Results</h4>
							<span class="text-muted">Find below the students final result for  session <strong><?php print $this->session_m->getActiveSession()->title; ?></strong>.</span>
						</div>
						<div class="card-body">
							<div class="row">	
								<div class="col-sm-3">
						...
						<table class="table tasks-responsive table-lg">
							...
							<tbody>
								...
								<tr ng-repeat="row in responseData.rows">
					                ...
					                <td>
					                	<div><a ng-href="<?php print $this->CONT_ROOT.'resdetail/';?>{{row.mid}}" class="font-weight-semibold">
									...
									<td>
										<div class="list-icons float-right">
											<div class="btn-group list-icons-item dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a ng-href="<?php print $this->CONT_ROOT.'resdetail/';?>{{row.mid}}" class="dropdown-item"><i class="icon-eye"></i>View Details</a>
													<a ng-href="<?php print $this->CONT_ROOT.'printing/report/?rpt=marksheet&usr='?>{{row.mid}}" class="dropdown-item" target="_blank">
