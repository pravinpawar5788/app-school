	...
	<div class="page-header page-header-light border-bottom-0" ng-init="pid='<?php print $record->mid;?>'">
		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Subject Detail</span> -  <u><?php print $record->name ?></u> of class <u><?php print $class->title; ?></u></h4>
		...
		<div class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="navbar-collapse collapse" id="navbar-second">
				<ul class="nav navbar-nav">
					<li class="nav-item">
						<a href="#profile" class="navbar-nav-link active" data-toggle="tab" ng-click="loadLessons()" style="color:<?php $clr=get_random_hax_color('dark'); print $clr;?>;">
							<i class="icon-reading mr-2" style="color:<?php print $clr;?>;"></i>
							Lessons
						</a>
					</li>
					<li class="nav-item">
						<a href="#progress" class="navbar-nav-link" data-toggle="tab" ng-click="loadProgress()" style="color:<?php $clr=get_random_hax_color('dark'); print $clr;?>;">
							<i class="icon-books mr-2" style="color:<?php print $clr;?>;"></i>
							Planning &amp; Progress
						</a>
					</li>
					<li class="nav-item">
						<a href="#qbank" class="navbar-nav-link" data-toggle="tab" ng-click="loadQbank()" style="color:<?php $clr=get_random_hax_color('dark'); print $clr;?>;">
							<i class="icon-archive mr-2" style="color:<?php print $clr;?>;"></i>
							Question Bank
						</a>
					</li> 
					<li class="nav-item">
						<a href="#faculty" class="navbar-nav-link" data-toggle="tab" ng-click="loadFaculty()" style="color:<?php $clr=get_random_hax_color('dark'); print $clr;?>;">
							<i class="icon-users4 mr-2" style="color:<?php print $clr;?>;"></i>
							Subject Faculty
						</a>
					</li> 
					<li class="nav-item">
						<a href="<?php print $this->CONT_ROOT.'curriculum/'.$class->mid.'';?>" class="navbar-nav-link" style="color:<?php $clr=get_random_hax_color('dark'); print $clr;?>;">
	...
	<div class="content">
		...
		<div class="d-flex align-items-start flex-column flex-md-row">
			...
			<div class="tab-content w-100 overflow-auto order-2 order-md-1">
			    ...
			    <div class="tab-pane fade <?php print $tab=='progress' ? 'active show': '';?>" id="progress">
					...
					<div class="card">
						<div class="card-header header-elements-inline">
							...
							<span class="d-block font-size-base text-muted">You may create a plan to complete the subject content for the current session. Later, you can track the subject progress. It is very helpful for teachers, students and parents to follow the plan.
							</span>
							</h5>
						</div>
						<div class="card-body">
							<div class="row">	
								<div class="col-sm-2">
									<select class="form-control select form-control-lg" ng-model="entry.chapter" ng-change="loadChapterLessons('progress')" data-fouc>
								...
								<div class="col-sm-6">
									<div class="input-group mb-3">
										<div class="form-group-feedback form-group-feedback-left">
											<input type="text" class="form-control form-control-lg alpha-grey datepicker" ng-model="entry.date" placeholder="Select Date" >
											<div class="form-control-feedback form-control-feedback-lg">
										...
										<div class="input-group-append">
											<button ng-click="saveProgress()" class="btn btn-success btn-lg">
			    ...
			    <div class="tab-pane fade <?php print $tab=='faculty' ? 'active show': '';?>" id="faculty">
					
					<!-- List table -->
					<div class="card">
						<div class="card-header header-elements-inline">
							<h5 class="card-title">Assign Faculty
							<span class="d-block font-size-base text-muted">All teachers assigned to this subject can access and update curriculum of this subject in their account.
							</span>
							</h5>
						</div>
						<div class="card-body">
							<div class="row">						
								<div class="col-sm-12">
									<div class="input-group mb-3">
										<div class="form-group-feedback form-group-feedback-left">
											<select class="form-control select-search form-control-lg" ng-model="entry.staff_id" data-fouc>
											<option value="">Select Teacher</option>
											<?php 
											foreach($faculty as $row){?>            
											    <option value="<?php print $row['mid'];?>" /><?php print $row['name'].'('.$row['staff_id'].')';?>
										    <?php }?>
											</select>
										</div>

										<div class="input-group-append">
											<button ng-click="saveFaculty()" class="btn btn-success">
						...
						<table class="table tasks-responsive table-lg">
							<thead>
								<tr>
									...
									<th class="font-weight-bold">Core Subjects</th>
									<th class="text-center text-muted" style="width: 30px;"><i class="icon-checkmark3"></i></th>
					            </tr>
							</thead>
							<tbody>
								...
								<tr ng-repeat="row in responseData.rows">
									...
									<td class="text-center">
										<?php if($this->LOGIN_USER->prm_class>2){?>
										<a class="mouse-pointer" ng-click="delFaculty(row)"><i class="icon-cross text-danger"></i></a>
										<?php }?>
									</td>
					            </tr>
						...
						<br><br><br>
						<div>
						<button ng-show="appConfig.showBtnBack===true" class="btn btn-success m-3 font-weight-bold" ng-click="moveBack();loadFaculty()">
						<i class="icon-arrow-left52"></i> Back Page</button>
						<button ng-show="appConfig.showBtnNext===true" class="btn btn-success m-3 float-right " ng-click="moveNext();loadFaculty()">
						 Next Page <i class="icon-arrow-right6"></i></button>
						<br><br><br>
						</div>
