	...
	<div class="page-header page-header-light border-bottom-0">
		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Reports</span> - SMS History</h4>
			    ...
			    <div class="tab-pane fade <?php print empty($tab) || $tab=='index' ? 'active show': '';?>" id="index">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							...
							<span class="text-muted">Search message.</span>
						</div>
						<div class="card-body">
								...
								<div class="row">
									...
									<!-- <div class="col-sm-1">
										<a class="btn btn-info text-white" <?php print $this->MODAL_OPTIONS;?> data-target="#refine-search">
												<i class="icon-filter3 mr-2"></i></a>
									</div> -->
								</div>
							</div>
							<div class="table-responsive">
								<p class="text-muted">Find below message system have sent to students &amp; staff.</p>
									...
									<tbody>
										...
										<tr ng-repeat="row in responseData.rows">
											...
											<td>{{row.mobile}}</td>
						  					<td>{{row.message}}</td>  
						  					<td style="width: 22%">
						  					<span data-ng-attr-title="{{row.response}}">
					  							{{row.date}}		
					  							<i class="icon-checkmark-circle2 text-success ml-1" ng-show="row.status=='sent'"></i>
						  					</span>
						  					</td> 
							            </tr>
