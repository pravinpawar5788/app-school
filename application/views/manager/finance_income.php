...
$accounts=$this->accounts_m->get_values_array('mid','title',array('campus_id'=>$this->CAMPUSID,'type'=>$this->accounts_m->TYPE_REVENUE,'period_id'=>$this->CURRENT_ACCOUNTING_PID));
$debit_accounts=$this->accounts_m->get_rows(array('campus_id'=>$this->CAMPUSID,'period_id'=>$this->CURRENT_ACCOUNTING_PID,'type'=>$this->accounts_m->TYPE_ASSETS,'is_current_asset >'=>0));
?>
<!-- Main content -->
	...
	<div class="page-header page-header-light border-bottom-0">
			...
			<div class="header-elements d-none">
				<div class="breadcrumb justify-content-center">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="<?php print $this->CONT_ROOT.'printing/report/?rpt=income';?>" class="dropdown-item"><i class="icon-cash"></i> Revenue Report</a>
		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Finance</span> - Revenue</h4>
			    ...
			    <div class="tab-pane fade <?php print empty($tab) || $tab=='index' ? 'active show': '';?>" id="index">
					...
					<div class="card">
						<div class="card-header bg-transparent">
							...
							<span class="text-muted">Search entries of the campus.</span>
						</div>
						<div class="card-body">
							...
							<div class="table-responsive">
								<p class="text-muted">Find below the entries for the campus. System will automatically create new entries. You may create manual entries alongside.</p>
	...
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p class="text-muted">EMS let you create new entries manul to reflect in monthly and anual reports</p>
				<div class="form-group">
					<div class="row">
						<div class="col-sm-3">
						...
						<div class="col-sm-2">
							<label class="text-muted">Received Via<span class="text-danger"> * </span></label>
							<select class="form-control select" ng-model="entry.debit_account" data-fouc>
