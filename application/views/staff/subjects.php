	...
	<div class="page-header page-header-light border-bottom-0">
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Assigned Subjects</span>
				</div>
		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Subjects</span> - Assigned Subjects</h4>
			    ...
			    <div class="tab-pane fade <?php print empty($tab) || $tab=='profile' ? 'active show': '';?>" id="profile">					
					...
					<div class="card">
						<div class="card-header header-elements-inline">
							<h5 class="card-title">Assigned Subjects
							<span class="d-block font-size-base text-muted">Find below the subjects assigned to you by adminisration. You may update the content (if applicable).
							</span>
							</h5>
						</div>
								...
								<tbody>
									...
									<tr ng-repeat="row in responseData.rows">
										<td>{{$index+1+(appConfig.currentPage*appConfig.pageLimit)}}</td>
					  					<td>{{row.class}}</td>  
										<td><a ng-href="<?php print $this->CONT_ROOT.'info/'?>{{row.subject.mid}}">{{row.subject.name}}</a></td>
					  					<td>{{row.subject.code}}</td>  
					  					<td>{{row.subject.chapters}}</td> 
										<td class="text-center">
											<div class="list-icons">
												<div class="list-icons-item dropdown">
													<a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown"><i class="icon-menu9 mr-5"></i></a>
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" ng-href="<?php print $this->CONT_ROOT.'info/'?>{{row.subject.mid}}">
														...
														<!-- <a class="dropdown-item"  <?php print $this->MODAL_OPTIONS;?> data-target="#homework" ng-click="selectRow(row)">
															<i class="icon-compose"></i> Assign Home Work
														</a> -->
													</div>
												</div>
											</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-success">
				<h6 class="modal-title">Assign homework of {{selectedRow.subject.name}} to {{selectedRow.class}} class</h6>
