...
<head>
  ...
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>staff/app_module.js<?php print $this->FILE_VERSION;?>"></script>
  <?php  foreach($this->ANGULAR_INC as $inc){?>
  <script type="text/javascript" src="<?php print $this->ANGULAR_ROOT;?>staff/<?php print $inc;?>.js<?php print $this->FILE_VERSION;?><?php print mt_rand(111111,999999);?>"></script>
  <?php }} ?>
  <!-- /angular js files -->
