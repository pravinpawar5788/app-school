			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
						<img src="<?php print $this->UPLOADS_ROOT;?>images/staff/profile/<?php print $this->LOGIN_USER->image;?>" class="rounded-circle" alt="" width="32" height="30">
						<span><?php print ucwords($this->LOGIN_USER->name);?></span>
					</a>

					<div class="dropdown-menu dropdown-menu-right">
						<a href="<?php print $this->LIB_CONT_ROOT;?>settings" class="dropdown-item"><i class="icon-cog5"></i> Settings</a>
						<a href="<?php print $this->APP_ROOT;?>auth/logout/staff" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
					</div>
				</li>
			</ul>
		</div>
