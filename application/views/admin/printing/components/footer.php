...
$(function(){
    ...
    $('.dropdown').on("mouseleave",function() {$(this).find('.content-area').stop(true, true).delay(900).fadeOut(500);});

    $('.dropdown-1').on("mouseenter",function() {$(this).find('.content-area-1').stop(true, true).delay(200).fadeIn(500);});
    $('.dropdown-1').on("mouseleave",function() {$(this).find('.content-area-1').stop(true, true).delay(900).fadeOut(500);});

    $('.dropdown-2').on("mouseenter",function() {$(this).find('.content-area-2').stop(true, true).delay(200).fadeIn(500);});
    $('.dropdown-2').on("mouseleave",function() {$(this).find('.content-area-2').stop(true, true).delay(900).fadeOut(500);});

    $('.dropdown-3').on("mouseenter",function() {$(this).find('.content-area-3').stop(true, true).delay(200).fadeIn(500);});
    $('.dropdown-3').on("mouseleave",function() {$(this).find('.content-area-3').stop(true, true).delay(900).fadeOut(500);});
