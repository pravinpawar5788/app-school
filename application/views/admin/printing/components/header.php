...
<head>
  ...
  <link rel="icon" href="<?php print $this->ORG_RES_ROOT.'images/logo/'.$this->ORG->logo;?>" type="image/x-icon" />
  <link rel="shortcut icon" href="<?php print $this->ORG_RES_ROOT.'images/logo/'.$this->ORG->logo;?>" type="image/x-icon" />
  <?php if(isset($print_page_title)){?>
  ...
  <div class="navbar navbar-expand-md navbar-dark fixed-top">
    <div class="navbar-brand">
      <a  href="<?php print $this->LIB_CONT_ROOT;?>" class="d-inline-block">
        <span class="brand-name"><?php print $this->APP_VERSION_NAME; ?><span class="brand-version"><?php print $this->APP_VERSION;?></span></span>
      </a>
    </div>
    <div class="d-md-none">
