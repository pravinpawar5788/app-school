...
<div class="page-header page-header-light">
	<div class="page-header-content header-elements-md-inline">
		<div class="page-title d-flex">
			<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">History</span> - Account History</h4>
		...
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">Account History</span>
			</div>
		</div>
	</div>
...
<div class="content">
	...
	<div class="card">
		<div class="card-header bg-transparent">
			...
			<span class="text-muted">Find below the activity history for this account.</span>
		</div>
