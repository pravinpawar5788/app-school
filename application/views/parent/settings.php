								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6">
											...
											<input type="text" value="<?php print $this->LOGIN_USER->parent_id ?>" readonly="readonly" class="form-control">
										</div>
									</div>
								</div>
					...
					<div class="card">
						<div class="card-body text-center">
							<div class="card-img-actions d-inline-block mb-3">
								<img class="img-fluid rounded-circle" src="<?php print $this->UPLOADS_ROOT.'images/parent/profile/'.$this->LOGIN_USER->image;?>" width="170" height="170" alt="">
							</div>
				    		...
				    		<span class="d-block text-muted"><span class="m-2">Parent ID:</span><?php print $this->LOGIN_USER->parent_id;?></span>
