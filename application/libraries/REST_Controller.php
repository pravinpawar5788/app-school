...
class Api_Controller extends REST_Controller {
    ...
    public $REQ_BACK_HIDE='hide';
     ...
     function __construct(){
        ...
        if (!$organization) {
            ...
            // $this->ORGSETTINGS = $this->setting_general_m->get_row_by_fields(array('org_id'=>$this->ORGID));
        }
    ...
    //function to handle the image data
    // public function base64ToImage($imageData){
    //     $upload_dir='./assets/uploads/images/clients/';
    //     $unique_file_name=strtoupper(get_random_string(3).date("dmyhi").mt_rand(11,99));
    //     //$data = 'data:image/png;base64,AAAFBfj42Pj4';
    //     list($type, $imageData) = explode(';', $imageData);
    //     list(,$extension) = explode('/',$type);
    //     list(,$imageData)      = explode(',', $imageData);
    //     $fileName =$unique_file_name.'.'.$extension;
    //     $imageData = base64_decode($imageData);
    //     if(file_put_contents($upload_dir.$fileName, $imageData)===FALSE){
    //         return '';
    //     }else{
    //         return $fileName;
    //     }
