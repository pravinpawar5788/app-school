...
class Stf_qual_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected $_model_name='Stf_qual_M.php';
	protected $_table_name = 'stf_qualification';
...
public function is_valid_data($data){
    if(empty($data['campus_id'])||empty($data['staff_id'])||empty($data['qualification'])){
        return false;        
    }
