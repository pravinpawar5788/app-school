...
class Std_subject_final_result_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected $_model_name='Std_subject_final_result_M.php';
	protected $_table_name = 'std_subject_final_result';
...
public function is_valid_data($data){
    ...
    if(empty($data['campus_id'])||empty($data['student_id'])||empty($data['session_id'])||empty($data['class_id'])||empty($data['subject_id'])||empty($data['subject_title']) ){
        return false;        
    }
