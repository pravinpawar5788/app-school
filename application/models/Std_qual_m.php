...
class Std_qual_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected $_model_name='Std_qual_M.php';
	protected $_table_name = 'std_qualification';
...
public function is_valid_data($data){
    if(empty($data['campus_id'])||empty($data['student_id'])||empty($data['session'])||empty($data['class'])){
        return false;        
    }
