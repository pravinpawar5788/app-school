<?php
class Class_subject_qbank_M extends MY_Model{

///////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////// INHERITED PROPERTIES //////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
protected $_model_name='Class_subject_qbank_M.php';
protected $_table_name = 'class_subject_questionbank';
...
public $TYPE_MCQ='mcq';
public $TYPE_LONG='long';
public $TYPE_SHORT='short';
public $TYPE_BOOLEAN='boolean';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////// PUBLIC FUNCTIONS /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////	
...
public function add_row($vals){
    ...
    ////////////////////////////////////////////////////////////////////////
    if(empty($db_row['type'])){$db_row['type']=$this->TYPE_MCQ;}
...
public function is_valid_data($data){
    if(empty($data['campus_id'])||empty($data['subject_id'])||empty($data['lesson_id'])||empty($data['chapter'])||empty($data['question'])||empty($data['marks'])){
        return false;
    }  
