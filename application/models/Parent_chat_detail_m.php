...
class Parent_chat_detail_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected $_model_name='Parent_chat_detail_M.php';
	protected $_table_name = 'parents_chat_detail';
...
public function is_valid_data($data){
    ...
    if(empty($data['campus_id'])||empty($data['message'])||empty($data['chat_id'])||empty($data['user_id'])){
        return false;
    }
