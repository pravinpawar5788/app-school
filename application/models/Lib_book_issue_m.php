...
class Lib_book_issue_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected $_model_name='Lib_book_issue_M.php';
	protected $_table_name = 'lib_issued_books';
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public $USER_STAFF='staff';
        public $USER_STUDENT='student';
...
public function is_valid_data($data){
    if(empty($data['campus_id'])||empty($data['user_id'])||empty($data['book_id'])){
        return false;        
    } 
