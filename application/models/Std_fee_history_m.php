...
class Std_fee_history_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        protected $_model_name='Std_fee_history_M.php';
	protected $_table_name = 'std_fee_history';
...
public function is_valid_data($data){
    if(empty($data['campus_id'])||empty($data['student_id'])||empty($data['amount'])){
        return false;        
    }
