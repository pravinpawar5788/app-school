...
class Parent_chat_M extends MY_Model
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected $_model_name='Parent_chat_M.php';
	protected $_table_name = 'parents_chat';
...
public function is_valid_data($data){
    if(empty($data['campus_id'])||empty($data['title'])||empty($data['parent_id'])){
        return false;
    }
